...
async function loadConfig() {
    ...
    try {
        ...
        try {
            ...
            categories = [];
            objects = [];
            showCustomAlert((typeof window.getTranslation === 'function' ? window.getTranslation('config-load-failed') : null) || 'Could not load inventory!\n\nIf opening HTML directly, you need to:\n1. Run a local server, OR\n2. Upload to GitHub Pages\n\nBrowser blocks file:// access to JSON files for security.', 'error');
        }
    }
}
